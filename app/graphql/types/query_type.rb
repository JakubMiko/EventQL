...
module Types
  class QueryType < Types::BaseObject
    ...
    # Event queries
    field :events, resolver: Queries::Events::ListEvents, connection: true, description: "Get all events with optional filters (no auth required)", max_page_size: 50, default_page_size: 10
